      ...
      <main className="home-container">
        <section className="hero">
          ...
          <div className="all-text">
            <p className="big-text">Educational Academy</p>
            <p className="text">
              A premier institution dedicated to academic excellence and
              holistic development. Our innovative learning environment fosters
              creativity, critical thinking, and lifelong learning skills.
            </p>
          </div>
        </section>
        <div className="content">
          <h2>Welcome to Educational Academy</h2>
          <p>
            A premier institution dedicated to academic excellence and holistic
            development. Our innovative learning environment fosters creativity,
        ...
        <section className="activitiesSection">
          <h3 className="sectionTitle">Activities & Events</h3>
          <div className="activityCards">
            <div className="activityCard">
              <h4>Science Fair</h4>
              <p>May 15, 2025 | Main Auditorium</p>
            </div>
            <div className="activityCard">
              <h4>Sports Day</h4>
              <p>May 22, 2025 | School Grounds</p>
            </div>
            <div className="activityCard">
              <h4>Parent-Teacher Meeting</h4>
              <p>May 30, 2025 | Classrooms</p>
            </div>
          </div>
        </section>
